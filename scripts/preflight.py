...
def check_required_files(data_cfg: dict, cache_dir: str) -> list[str]:
    ...
    required = {
        "n1hat_it_matrix":  data_cfg.get("n1hat_it_matrix",  "./n1hat_it_matrix_ordered.npy"),
        "n1hat_rm_matrix":  data_cfg.get("n1hat_rm_matrix",  "./n1hat_rm_matrix_ordered.npy"),
        "books":            data_cfg.get("books",            "./books_dashboard_ordered.npy"),
        "impr_names":       data_cfg.get("impr_names",       "./impr_names_dashboard_ordered.npy"),
        "symbs":            data_cfg.get("symbs",            "./symbs_dashboard.npy"),
...
def check_optional_files(data_cfg: dict, umap_cfg: dict) -> None:
    ...
    optional = {
        "w_rm_matrix":  data_cfg.get("w_rm_matrix",  "./w_rm_matrix_ordered.npy"),
        "w_it_matrix":  data_cfg.get("w_it_matrix",  "./w_it_matrix_ordered.npy"),
    }
...
def generate_edge_caches(data_cfg: dict, net_cfg: dict, cache_dir: str) -> bool:
    ...
    w_rm_path = data_cfg.get("w_rm_matrix", "./w_rm_matrix_ordered.npy")
    w_it_path = data_cfg.get("w_it_matrix", "./w_it_matrix_ordered.npy")
...
def generate_umap_caches(data_cfg: dict, umap_cfg: dict, *, skip: bool = False) -> bool:
    ...
    fonts_and_matrices = {
        "roman":    data_cfg.get("n1hat_rm_matrix", "./n1hat_rm_matrix_ordered.npy"),
        "italic":   data_cfg.get("n1hat_it_matrix", "./n1hat_it_matrix_ordered.npy"),
    ...
    rm_path = data_cfg.get("n1hat_rm_matrix", "./n1hat_rm_matrix_ordered.npy")
    it_path = data_cfg.get("n1hat_it_matrix", "./n1hat_it_matrix_ordered.npy")
...
def main() -> int:
    ...
    cache_dir = img_cfg.get("cache_dir", "./images_cache/")
    ...
    books_path = data_cfg.get("books", "./books_dashboard_ordered.npy")
